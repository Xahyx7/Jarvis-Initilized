// Specialized test generation using AI providers
...
export default async function handler(req, res) {
    ...
    try {
        ...
        // Try providers for test generation
...
// Generate test content using AI provider
...
Provide a complete, ready-to-use test with clear formatting.`;
    ...
    const response = await fetch(provider.url, {
        ...
        headers: {
            ...
            'User-Agent': 'JARVIS-TestGen/4.0'
        },
        body: JSON.stringify({
            model: provider.model,
            messages: messages,
            max_tokens: 3000, // Longer for comprehensive tests
            temperature: 0.8, // Slightly higher for creative test questions
            stream: false
        })
    });
